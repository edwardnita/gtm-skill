...
**Fallback output was produced:** 2026-08-28, ~18:40 EEST, by running the seed prompt against the live TED API during the build window (retrieval timestamp 15:37 UTC is embedded in the report).
