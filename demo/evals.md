...
| --- | --- | --- | --- | --- | --- |
| Intended | `demo/input/request.md` (software development & IT services, Romania) | `report.html` written with a 0–100 score, buyers, winners, 3 linked tenders; every figure from the live TED API with retrieval timestamp; no unreplaced template tokens | Report written: 100/100 "Strong signal", 733 contract notices/12mo, 65 distinct buyers, top winner SIVECO Technology 8/100 sampled awards, 3 example tenders published 2026-08-28 with ted.europa.eu links; retrieval timestamp 2026-08-28 16:01 UTC shown in header and footer; zero tokens left; PDF/CSV export buttons render | Pass | `demo/output/report.html`, raw API data in `demo/output/ted-data.json` |
...
- **When:** 2026-08-28, 18:35–19:05 EEST (Europe/Bucharest), during the build window; re-run after score-band recalibration and export feature at ~19:01 EEST (16:01 UTC)
