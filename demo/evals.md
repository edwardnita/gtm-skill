...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Intended | `demo/input/expansion_request.json` | Computes 50.0% landed margin, verifies German VerpackG (LUCID) & FCM DoC, checks Apify Reddit pulse (+67.2 net score), and outputs `GO` verdict with 94/100 score and full citation audit trail | Successfully produced complete Expansion Decision Brief with `[ GO ]` verdict, 94/100 score, and verified citations | pass | `demo/output/expansion_brief.md` |
